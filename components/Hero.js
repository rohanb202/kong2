...
export default function Hero() {
  ...
  return (
    <section
      className={`h-screen mx-5 my-6 text-white  backdrop-blur-sm  md:mx-10 rounded-3xl ${
        themeX == "dark"
          ? ` border-[1px] bg-gradient-to-l from-slate-100 to-slate-800 `
    ...
    >
      <div className="flex flex-col items-center justify-between h-full md:justify-between md:flex-row">
        <div className="flex flex-col items-center p-10 mt-2 md:space-y-6 md:items-start">
          ...
          <h1 className="text-3xl font-bold text-center md:text-left lg:text-7xl">
            {" "}
            The AI community <br /> building the <br /> future.
          </h1>
