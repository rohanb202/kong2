...
export default function ModelCard({ModelData}) {
  return (
    ...
    <div className='p-2 group hover:cursor-pointer mr-2 mt-2 rounded-md bg-slate-200 w-[25rem] flex flex-grow flex-col'>
        <div>
            <h2 className='group-hover:text-blue-600 '>{ModelData.author}/{ModelData.title}</h2>            
        </div>
