        ...
        <hr></hr>
            <div >
                <div className='relative flex flex-col items-center justify-center m-auto my-2'>
                    ...
                    <h1 className='text-3xl font-semibold text-zinc-600'>Kong</h1>
                </div>
                <div className='flex flex-col justify-center w-full pt-5 space-y-4 md:items-center md:flex-row md:space-y-0 md:space-x-7'>
                    ...
                    <div className='flex items-center justify-center space-x-2'>
                        <MapIcon className='w-8 p-1 text-white rounded-full bg-zinc-600'/>
                        <h1>26 BakerStreet,10117 India</h1>
                    </div>
                    <div className='flex items-center justify-center space-x-2'>
                        <EnvelopeIcon className='w-8 p-1 text-white rounded-full bg-zinc-600'/>
                ...
                <div className='flex justify-center'>
                    <footer className='pt-10 pb-5 font-light'>&#169; 2024 xono All rights reserved</footer>                  
                </div>
