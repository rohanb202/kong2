  ...
  return (
    <div ref={component} className="overflow-hidden ">
      <div className="flex flex-col items-center justify-center mx-20 my-20 space-y-20 md:space-y-0 md:space-x-10 md:flex-row">
        <div className="text-3xl font-bold text-center md:text-left md:w-1/3">
          Enterprise
        </div>
        ...
        <div className="text-lg text-center md:text-left md:w-1/3">
          a vibrant AI community hub designed to foster collaboration,
      ...
      <div ref={slider} className="my-10 ">
        <div>
          <h1
            ...
            className="mx-5 text-3xl font-bold md:text-5xl"
          >
            Our Open Source
          </h1>
        </div>
        <div className="flex justify-center w-screen my-10 space-x-10 text-white ">
          ...
          <SlideCard
            img={smile}
            color={`dark:border-[1px] ${
              theme == "dark"
                ? " text-black bg-gradient-to-l from-amber-300 to-amber-500  "
                : " bg-gradient-to-l from-amber-700 to-amber-900 "
            } backdrop-blur-sm `}
            title={`Transformers`}
            desc={`State-of-the-art ML for
Pytorch, TensorFlow, and
JAX.`}
          />

          <SlideCard
            color={` dark:border-[1px]  backdrop-blur-sm ${
              theme == "dark"
                ? " text-black bg-gradient-to-l from-sky-300 to-sky-500  "
                : " bg-gradient-to-l from-sky-700 to-sky-900 "
            } `}
            img={smile}
            title={`Diffusers`}
            desc={`State-of-the-art diffusion
...
generation in PyTorch.`}
          ...
          <SlideCard
            ...
            color={`dark:border-[1px] backdrop-blur-sm ${
              theme == "dark"
                ? " text-black bg-gradient-to-l from-fuchsia-300 to-fuchsia-500  "
                : " bg-gradient-to-l from-fuchsia-700 to-fuchsia-900 "
            }`}
            title={`Timm`}
            desc={`State-of-the-art computer
...
utilities.`}
          ...
          <SlideCard
            color={` dark:border-[1px] backdrop-blur-sm ${
              theme == "dark"
                ? " text-black bg-gradient-to-l from-green-300 to-green-500  "
                : " bg-gradient-to-l from-green-700 to-green-900 "
            }`}
            img={smile}
            title={`PEFT`}
